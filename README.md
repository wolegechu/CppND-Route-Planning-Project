...
```
git clone https://github.com/wolegechu/CppND-Route-Planning-Project.git --recurse-submodules
```
or with SSH:
```
git clone git@github.com:wolegechu/CppND-Route-Planning-Project.git --recurse-submodules
```
